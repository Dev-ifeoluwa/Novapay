...
export default function Payment() {
  return (
    <div className="px-2 py-8 md:px-8 bg-green-700">
      <div className="flex flex-col-reverse gap-5 items-center md:flex-row justify-between px-2 py-3 md:px-8 md:py-6">
        {/* left */}
        <div className="flex flex-col gap-6 w-full max-w-md">
          ...
          <p className="text-md md:text-xl text-gray-300">
            ...
            ones, buy airtime and settle bills effortlessly. 
            At Moniepoint, we keep your financial happiness flowing!
          </p>
          <Link 
            href={"/"}
        ...
        <Animate type="fade-down" delay={300}>
          <Image src={"/hero00.png"} alt="" width={800} height={500} />
        </Animate>
        </div>
      </div>
    </div>
